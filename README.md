# MATLAB-Image-Processing-Fundamentals
  ...
  This repository contains a collection of fundamental image processing and computer vision algorithms implemented in MATLAB.

  The project was developed during the Image Processing & Recognition course at Częstochowa University of Technology as part of the Erasmus+ exchange program.

  The primary focus of this repository is the manual implementation of core algorithms using pixel-wise operations and custom matrix manipulations to better understand the mathematical foundations of image processing.
